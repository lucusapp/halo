...
// Infraestructura de verificación de JWT de Clerk (guards + service), separada de
...
@Module({
  providers: [ClerkService, JwtAuthGuard, AdminGuard],
  exports: [ClerkService, JwtAuthGuard, AdminGuard],
})
